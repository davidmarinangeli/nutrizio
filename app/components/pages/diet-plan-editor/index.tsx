...
export default function DietPlanEditor({
  ...
  const generateAIAlternatives = async () => {
    if (!selectedFoodForAlternatives || !patient) return
    ...
    try {
      ...
      const request: GenerateAlternativesRequest = {
        ...
        patientData: {
          ...
          sex: "F", // Default since sex is not in Patient interface
          height: patient.height?.toString() || "170",
          weight: patient.weight?.toString() || "70",
          targetCalories: patient.target_calories?.toString() || "2000",
          mainGoal: patient.main_goal || "health",
              ...
              <div className="col-span-12 md:col-span-6">
                ...
                >
                  <CardHeader className="text-center pb-4 border-b border-emerald-200 dark:border-gray-700">
                    ...
                    <p className="text-emerald-600 dark:text-emerald-400 text-lg mt-1">Oggi</p>
                  </CardHeader>
                      ...
                      >
                        <CardContent className="p-4">
                          <div className="flex items-center justify-between mb-3">
                            <h3 className="text-lg font-bold text-gray-800 dark:text-gray-200">{meal.meal_name}</h3>
